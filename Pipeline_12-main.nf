...
workflow {
    ...
    FastaConversion(sampleName_ch, Filtering.out.fixed_vcf, Filtering.out.fixed_idx, Filtering.out.unfixed_vcf, Filtering.out.unfixed_idx, ref_file, ref_index_file, ref_dict_file)
