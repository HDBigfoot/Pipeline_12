...
process Annotation {
    ...
    output:
        ...
        path "${masked_fixed_vcf}.ann.fixed.vcf", emit: ann_fixed_vcf
    ...
    sed 's/NC_000962.3/Chromosome/' ${masked_fixed_vcf} > ${masked_fixed_vcf}.chr.fixed.vcf
    ...
    java -jar ${projectDir}/snpEff/snpEff.jar -v Mycobacterium_tuberculosis_h37rv ${masked_fixed_vcf}.chr.fixed.vcf > ${masked_fixed_vcf}.ann.fixed.vcf
    """
